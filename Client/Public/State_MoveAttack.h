...
BEGIN(Client)
class CState_MoveAttack final : public CPlayer_State
{
private:
	CState_MoveAttack(class CPart** pParts, _uint iNumParts, class CTransform* pTransform, 
	...
	virtual ~CState_MoveAttack() = default;
...
public:
	static CState_MoveAttack* Create(class CPart** pParts, _uint iNumParts, class CTransform* pTransform, 
		_float& fFireDelay, _float3* pTargetPos, _uint iPlayerCharacter, _bool* pUseSkill, 
