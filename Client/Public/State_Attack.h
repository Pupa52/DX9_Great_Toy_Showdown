...
BEGIN(Client)
class CState_Attack final : public CPlayer_State
{
private:
	CState_Attack(class CPart** pParts, _uint iNumParts, class CTransform* pTransform, 
...
public:
	static CState_Attack* Create(class CPart** pParts, _uint iNumParts, class CTransform* pTransform, 
		_float& fFireDelay, _float3* pTargetPos, _uint iPlayerCharacter, _bool* pUseSkill, 
