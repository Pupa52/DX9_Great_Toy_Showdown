...
BEGIN(Client)
class CState_Idle final : public CPlayer_State
{
private:
	CState_Idle(class CPart** pParts, _uint iNumParts, class CTransform* pTransform,
...
public:
	static CState_Idle* Create(class CPart** pParts, _uint iNumParts, class CTransform* pTransform,
		_float& fFireDelay, _float3* pTargetPos, _uint iPlayerCharacter, _bool* pUseSkill, 
